...
$sql1 = "INSERT into datos_medidos (ID_TARJ, temperatura, humedad, fecha, hora, estado_lluvia) VALUES ('$ID_TARJ', '$temp', '$hum', '$fecha', '$hora', '$estado_lluvia')"; // Aqu� se ingresa el valor recibido a la base de datos.
