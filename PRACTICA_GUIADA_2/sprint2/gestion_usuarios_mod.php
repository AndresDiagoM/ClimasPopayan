...
if ((isset($_POST["enviado"])))
  {
   ...
   $sqlu8 = "UPDATE usuarios set estado_civil='$estado_civil' where id='$id_usu_enc'";    
   $resultsqlu8 = $mysqli->query($sqlu8);
   $sqlu10 = "UPDATE usuarios set ocupacion='$ocupacion' where id='$id_usu_enc'";    
	   ...
	   <tr valign="top">
	     ...
	     <tr>
           ...
           ?>
			  ...
			  <tr>
				<td bgcolor="#D1E8FF" align=center> 
				  <font FACE="arial" SIZE=2 color="#000044"> <b>Direcci�n</b></font>  
				</td>
				<td bgcolor="#EEEEEE" align=center> 
...
<select name=activo required> 
        ...
        <td bgcolor="#EEEEEE" align=center> 
          <select name=estado_civil required> 
            <option value="<?php echo $estado_civil; ?>"> <?php echo $var; ?></option>  
            <?php
            $var="soltero";
            $desc_activo_con = "soltero";
            if ($var != $estado_civil)
                {
            ?>   
                <option value="<?php echo $var; ?>"> <?php echo $desc_activo_con; ?></option>  
            <?php
                }
            else
                {    
