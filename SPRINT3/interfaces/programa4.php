...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 	Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  <html>
    <head>
      <title> DATOS MAXIMOS, Sistema medición de clima
		  </title>
    </head>
    <body>
      <table width="80%" align=center cellpadding=5 border=1 bgcolor="#FFFFFF">
         ...
         <td valign="top" align=center width=80& colspan=6 bgcolor="#4DB9D1"">
 	     ...
 	     <tr>
         <td valign="top" align=center width=80& colspan=6 bgcolor="#4DB9D1"">
           <h1> <font color=white>Consulta y modifica datos MAXIMOS, Sistema medición de clima</font></h1>
         </td>
 	     </tr>
<?php
...
?>    
   ...
   <tr>	
        <form method=POST align=center action="../../default.php">
