...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 	Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  <html>
    <head>
      <title> Consulta datos historicos cada sector
		  </title>
    </head>
    <body>
      <table width="80%" align=center cellpadding=5 border=1 bgcolor="#FFFFFF">
         ...
         <td valign="top" align=center width=80& colspan=8 bgcolor="#4DB9D1"">
           <h1> <font color=white>Consulta Datos Historicos por Region</font></h1>
         </td>
...
echo' 
   <tr>	
        <form method=POST align=center action="Datos_historicos_consul.php">
...
?>    
       ...
       <form method=POST action="Datos_historicos_consul.php">
