...
if ((isset($_POST["enviado"])))
  {
   ...
   if ($numero_filas > 0)
    ...
    {
      $sql = "INSERT INTO usuarios(tipo_usuario, nombre_completo, identificacion, passwd, direccion, login, activo, id_tarjeta, estado_civil, ocupacion) 
      VALUES ('$tipo_usuario','$nombre_usuario','$num_id','$password_enc','$direccion','$login','$activo','$id_tarjeta', '$estado_civil','$ocupacion' )";
      //echo "sql es...".$sql;
   ...
   ?>
	   ...
	   <tr valign="top">
	     ...
	     <tr>
           ...
           <?php 	
           $sql6 = "SELECT * from tipo_usuario  WHERE id = 1 order by id DESC";
	     ...
	     <tr>
				<td bgcolor="#A8DDA8" align=center> 
				  <font FACE="arial" SIZE=2 color="#004400"> <b>Direcci�n</b></font>  
				</td>
				<td bgcolor="#EEEEEE" align=center> 
			 ...
			 <tr>
				<td bgcolor="#A8DDA8" align=center> 
				  <font FACE="arial" SIZE=2 color="#004400"> <b>Tel�fono</b></font>  
				</td>
			     <td bgcolor="#EEEEEE" align=center> 
       ...
       <tr>      
        <td bgcolor="#A8DDA8" align=center> 
				  <font FACE="arial" SIZE=2 color="#000044"> <b>estado civil</b></font>  
           ...
           <?php 	
           echo "hola";
           $sql_loca = "SELECT * from EstadoCivil order by id ASC";
           ...
           ?>   
            ...
            <option name="estado_civil" value="<?php echo $est_2; ?>"> <?php echo $est_2; ?></option>  
       ...
       <tr>	
				<td bgcolor="#A8DDA8" align=center> 
				  <font FACE="arial" SIZE=2 color="#000044"> <b>ocupacion</b></font>  
				</td>	
				<td bgcolor="#EEEEEE" align=center> 
				  <input type="text" name=ocupacion value="<?php echo ""; ?>" required>  
				</td>	
	     </tr>
      </table>
         </br>
