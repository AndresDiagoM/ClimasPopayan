...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 	Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  <html>
    <head>
      <title> 10 ULTIMOS DATOS MEDIDOS
		  </title>
    </head>
    <body>
      <table width="80%" align=center cellpadding=5 border=1 bgcolor="#FFFFFF">
         ...
         <td valign="top" align=center width=80& colspan=8 bgcolor="#4DB9D1"">
 	     ...
 	     <tr>
         <td valign="top" align=center width=80& colspan=8 bgcolor="#4DB9D1"">
           <h1> <font color=white>10 ULTIMOS DATOS MEDIDOS</font></h1>
         </td>
...
$sql1 = "SELECT * from datos_medidos where ID_TARJ=$ID_TARJ LIMIT 10"; 
...
echo' 
   <tr>	
        <form method=POST align=center action="Sectores_Medicion_10Datos.php">
...
?>    
       ...
       <form method=POST action="Sectores_Medicion_10Datos.php">
