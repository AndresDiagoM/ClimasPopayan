    ...
    <body>
      <table width="80%" align=center cellpadding=5 border=1 bgcolor="#FFFFFF">
         ...
         <td valign="top" align=center width=80% colspan=9 bgcolor="#4DB9D1"">
 	     ...
 	     <tr>
         <td valign="top" align=center width=80% colspan=9 bgcolor="#4DB9D1"">
           <h1> <font color=white>Ultimos datos medidos sistema medición de clima</font></h1>
         </td>
 	     </tr>
    	 <tr>
...
$sql1 = "SELECT * from datos_medidos where (ID_TARJ=1 or ID_TARJ=2 or ID_TARJ=3 or ID_TARJ=4) order by id DESC LIMIT 5"; // Aquí se ingresa el valor recibido a la base de datos.
// la siguiente línea ejecuta la consulta guardada en la variable sql, con ayuda del objeto de conexión a la base de datos mysqli
...
?>
   ...
   <tr>	
        <form method=POST action="programa22.php">
