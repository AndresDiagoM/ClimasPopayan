    ...
    <body>
      <table width="80%" align=center cellpadding=5 border=1 bgcolor="#FFFFFF">
         ...
         <td valign="top" align=center width=80& colspan=8 bgcolor="#4DB9D1"">
 	     ...
 	     <tr>
         <td valign="top" align=center width=80& colspan=8 bgcolor="#4DB9D1"">
           <h1> <font color=white>Consulta datos historicos cada sector</font></h1>
         </td>
...
echo' 
   <tr>	
        <form method=POST align=center action="Sectores_Medicion.php">
...
?>    
       ...
       <form method=POST action="Sectores_Medicion.php">
